...
import { Moon, Grid, List, Filter } from 'lucide-react'
...
export default function NightlifeClient() {
  const [allEvents] = useState<Event[]>(() => getNightlifeEvents())
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm opacity-75">Venues & Events</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-300">
                {new Set(allEvents.map(e => e.subcategory)).size}
              </div>
              <div className="text-sm opacity-75">Event Types</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-300">
                {allEvents.filter(e => e.ageRestriction?.includes('21')).length}
              </div>
              <div className="text-sm opacity-75">21+ Venues</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-300">
                {new Set(allEvents.map(e => e.location.neighborhood)).size}
              </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <select
                ...
                className="px-4 py-2 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-pittsburgh-gold focus:border-transparent"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {filteredEvents.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-semibold text-gray-300 mb-2">No nightlife events found</h3>
