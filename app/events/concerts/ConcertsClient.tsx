...
export default function ConcertsClient() {
  const [allEvents] = useState<Event[]>(() => getConcerts())
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm opacity-75">Concerts</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm opacity-75">Free Shows</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-300">
                {new Set(allEvents.map(e => e.venue.name)).size}
              </div>
