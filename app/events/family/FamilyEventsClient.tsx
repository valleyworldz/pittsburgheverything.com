...
import { Users, Grid, List, Filter, Heart } from 'lucide-react'
...
export default function FamilyEventsClient() {
  const [allEvents] = useState<Event[]>(() => getFamilyEvents())
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className="text-sm opacity-75">Family Events</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm opacity-75">Activity Types</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-yellow-300">
                {allEvents.filter(e => e.accessibility?.wheelchairAccessible).length}
              </div>
              <div className="text-sm opacity-75">Accessible</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {filteredEvents.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-semibold text-gray-700 mb-2">No family events found</h3>
